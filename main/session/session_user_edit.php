...
$form->addElement('number', 'duration', [get_lang('ExtraDurationForUser'), '⚠️ El valor indicado es la cantidad de días DESDE la fecha de PRIMER ACCESO', get_lang('Days')]);
