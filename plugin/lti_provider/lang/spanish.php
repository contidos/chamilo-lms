...
$strings['LessonsAtCourses'] = 'Lecciones en cursos';
$strings['LessonsAtSessions'] = 'Lecciones en sesiones';
$strings['AvailableLicenses'] = 'Licencias'; 
$strings['Deactivate'] = 'Desactivar';
$strings['ConfirmYourChoice'] = '¿Está seguro de querer desactivar esta licencia?';
$strings['LicenseDeleted'] = 'Licencia desactivada';
$strings['ErrorDeletingLicense'] = 'Error al desactivar la licencia';
$strings['NoLicensesFound'] = 'No se encontraron licencias';
$strings['ExpeditionDate'] = 'Fecha alta';
$strings['Licenses'] = 'Licencias';
$strings['plugin_title'] = 'LTI Provider';
$strings['plugin_comment'] = 'Plugin LTI Provider para Chamilo LMS';
$strings['NoLicense'] = 'Sin Licencia Disponible';
$strings['NoLicenseMessage'] = 'No tiene una licencia activa para acceder a este contenido. Por favor, contacte con su administrador para solicitar acceso.';
$strings['BackToHome'] = 'Volver al Inicio'; 
