...
$strings['AvailableLicenses'] = 'Licenses'; 
$strings['Deactivate'] = 'Deactivate';
$strings['ConfirmYourChoice'] = 'Are you sure you want to deactivate this license?';
$strings['LicenseDeleted'] = 'License deleted';
$strings['ErrorDeletingLicense'] = 'Error deleting license';
$strings['ExpeditionDate'] = 'Fecha alta';
$strings['Licenses'] = 'Licenses';
$strings['plugin_title'] = 'LTI Provider';
$strings['plugin_comment'] = 'LTI Provider plugin for Chamilo LMS';
$strings['NoLicense'] = 'No License Available';
$strings['NoLicenseMessage'] = 'You do not have an active license to access this content. Please contact your administrator to request access.';
